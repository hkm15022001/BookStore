...
public class KhachHangDAO implements DAOInterface<KhachHang> {
	...
	public int insert(KhachHang t) {
		...
		try {
			...
			// Bước 2: tạo ra đối tượng statement
			String sql = "INSERT INTO khachhang (makhachhang, tendangnhap, matkhau, hoten, gioitinh, diachi, diachinhanhang, diachimuahang, ngaysinh, sodienthoai, email, dangkinhanbangtin,maxacthuc,thoigianhieulucmaxacthuc,trangthaixacthuc) "
					+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			st.setObject(14, t.getThoiGianXacThuc());
	...
	public int update(KhachHang t) {
		...
		try {
			...
			String sql = "UPDATE khachhang " + " SET " + " tendangnhap=?" + ", matkhau=?" + ", hoten=?" + ", gioitinh=?"
					...
					+ ", email=?" + ", dangkinhanbangtin=?" + ", trangthaixacthuc=?" + " WHERE makhachhang=?";
			...
			st.setBoolean(12, t.isTrangThaiXacThuc());
			st.setString(13, t.getMaKhacHang());
			// Bước 3: thực thi câu lệnh SQL
...
//		if(khdao.selectByUsername("a").isEmpty()) {
//			khdao.insert(new KhachHang(generator.nextInt()+""+java.time.LocalTime.now(), "a", "", "", "",
