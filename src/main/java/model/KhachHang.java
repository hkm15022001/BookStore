...
public class KhachHang {
	...
	private Timestamp thoiGianXacThuc;
	...
	public KhachHang(String maKhacHang, String tenDangNhap, String matKhau, String hoVaTen, String gioiTinh,
			String diaChi, String diaChiNhanHang, String diaChiMuaHang, Date ngaySinh, String soDienThoai, String email,
			boolean dangKyNhanBangTin, String maXacThuc, Timestamp thoiGianXacThuc, boolean trangThaiXacThuc) {
		super();
		this.maKhacHang = maKhacHang;
		this.tenDangNhap = tenDangNhap;
		this.matKhau = matKhau;
	...
	public Timestamp getThoiGianXacThuc() {
		return thoiGianXacThuc;
	}

	public void setThoiGianXacThuc(Timestamp thoiGianXacThuc) {
		this.thoiGianXacThuc = thoiGianXacThuc;
	}
...
//		if(khdao.selectByUsername("b").isEmpty()) {
//			khdao.insert(new KhachHang(generator.nextInt()+""+java.time.LocalTime.now(), "b", "", "", "",
//					"", "", "", Date.valueOf("1997-03-10"), "", "",true));
//		}  
//			
//	}
}